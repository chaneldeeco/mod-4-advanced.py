...
def tic_tac_toe(board):
    ...
    # Checking diagonals
    if len(set([board[index][index] for index in range(len(board))])) == 1:
        return board[0][0]
    elif len(set([board[index][len(board)-index-1] for index in range(len(board))])) == 1:
